...
DEVS = ["R_R_B0", "X_x_DAD_7ODA_X_x","U_u_63","ZzzzOoooozZ"] #يوزرات المطورين المصنع
...
async def start(client, message):
   if message.from_user.username in DEVS:
     ...
     return await message.reply_text("اهلا بيك ف مصنع بوتات فينوم ", reply_markup=kep)
...
async def alivehi(client: Client, message):
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("𝙶𝚁𝙾𝚄𝙿️", url=f"https://t.me/M_b_c_c_c"),
                InlineKeyboardButton("𝚂𝙾𝚄𝚁𝙲𝙴️", url=f"https://t.me/RB_RO"),
            ],
            [
                 InlineKeyboardButton(f"𝗗𝗘𝗩 VENOM 💎", url=f"https://t.me/R_R_B0")
                  ]
                     [
                      InlineKeyboardButton(f"𝗗𝗘𝗩 MOSCOW 💎", url=f"https://t.me/U_u_63")
                     ]     
                     [
                      InlineKeyboardButton(f"𝗗𝗘𝗩 ZOZ 💎", url=f"https://t.me/ZzzzOoooozZ")       
                     ] 
                [
                    InlineKeyboardButton(f"𝗗𝗘𝗩 7ODA 💎", url=f"https://t.me/X_x_DAD_7ODA_X_x")
                   ]
    ...
    await message.reply_photo(
        photo="https://telegra.ph/file/54edefde18d81cca727c7.jpg",
        caption="",
